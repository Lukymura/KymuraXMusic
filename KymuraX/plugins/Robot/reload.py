...
from KymuraX.utils.database import get_authuser_names, get_cmode
from KymuraX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from KymuraX.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Kymura.stop_stream(message.chat.id)
    except:
        pass
