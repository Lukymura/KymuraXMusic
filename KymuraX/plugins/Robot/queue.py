...
from KymuraX import app
from KymuraX.misc import db
from KymuraX.utils import (Kymurabin, get_channeplayCB,
                              seconds_to_min)
from KymuraX.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from KymuraX.utils.decorators.language import language, languageCB
from KymuraX.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/d6e11859206d6e8850b21.jpg",
        caption=_["queue_1"],
    )
